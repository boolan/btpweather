					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Weather forecast via AJAX",
									"targetURL": "#btpweather-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"btpweather-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=btpweather",
									"url": sap.ui.require.toUrl("btpweather")
								}
							}
						}
					}
